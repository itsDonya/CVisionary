...
const PropertyCard = ({ icon: Icon, title, description }: PropertyItem) => {
  return (
    <div className="group relative p-6 bg-gradient-to-br from-purple-900/20 to-black/40 rounded-2xl border border-purple-500/20 backdrop-blur-sm hover:border-purple-400/40 transition-all duration-300 hover:transform hover:scale-105">
      <div className="mb-4">
      ...
      <div className="z-10">
        <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-purple-100 transition-colors duration-300 h-[3em]">
          {title}
        </h3>

        <p className="text-neutral-200/80 font-[200] leading-relaxed group-hover:text-neutral-300 transition-colors duration-300">
          {description}
        </p>
      </div>
    </div>
